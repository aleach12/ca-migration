...
plt.savefig('/Users/alanleach/Desktop/ca-mig-data/ca-migrants.png', dpi = 1000)
...
ax = geo_state_cont.plot(column = 'immigrants', cmap = 'Blues', edgecolor = 'black')


for idx, row in geo_state_points.iterrows():

    plt.annotate(s=row['immigrants'], xy=row['coords'],
